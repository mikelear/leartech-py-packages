...
class ApiCreateKeyResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["key", "keyid", "secret"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "key": ApiKeyView.from_dict(obj["key"]) if obj.get("key") is not None else None,
            "keyid": obj.get("keyid"),
