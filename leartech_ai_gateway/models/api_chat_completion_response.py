...
class ApiChatCompletionResponse(BaseModel):
    ...
    """ # noqa: E501
    choices: Optional[List[ApiChoice]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "choices": [ApiChoice.from_dict(_item) for _item in obj["choices"]] if obj.get("choices") is not None else None,
            "created": obj.get("created"),
            "id": obj.get("id"),
            "model": obj.get("model"),
            "object": obj.get("object"),
            "usage": ApiUsage.from_dict(obj["usage"]) if obj.get("usage") is not None else None
        })
        return _obj
