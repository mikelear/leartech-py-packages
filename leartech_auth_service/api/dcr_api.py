...
class DCRApi:
    ...
    async def d_cr_register(
        self,
        body: Annotated[DCRRegisterRequest, Field(description="Registration payload")],
        ...
        _param = self._d_cr_register_serialize(
            body=body,
    ...
    async def d_cr_register_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DCRRegisterResponse]:
        """Dynamic Client Registration (RFC 7591)
