# leartech_go_service_template.FleetTestApi
...
from leartech_go_service_template.models.handlers_fleet_test_response import HandlersFleetTestResponse
...
async with leartech_go_service_template.ApiClient(configuration) as api_client:
    ...
    api_instance = leartech_go_service_template.FleetTestApi(api_client)
