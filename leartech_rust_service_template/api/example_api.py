...
from leartech_rust_service_template.api_client import ApiClient, RequestSerialized
from leartech_rust_service_template.api_response import ApiResponse
from leartech_rust_service_template.rest import RESTResponseType
...
class ExampleApi:
    ...
    @validate_call
    async def example_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def example_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
