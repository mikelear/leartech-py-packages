...
class TestMaestroConsumeEventRequestDto(unittest.TestCase):
    """MaestroConsumeEventRequestDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MaestroConsumeEventRequestDto:
        """Test MaestroConsumeEventRequestDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MaestroConsumeEventRequestDto`
        """
        model = MaestroConsumeEventRequestDto()
        if include_optional:
            return MaestroConsumeEventRequestDto(
                actioned_by = '',
                annotations = {
                    'key' : ''
                    },
    ...
    def testMaestroConsumeEventRequestDto(self):
        """Test MaestroConsumeEventRequestDto"""
