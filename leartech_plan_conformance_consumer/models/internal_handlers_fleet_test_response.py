...
class InternalHandlersFleetTestResponse(BaseModel):
    """
    InternalHandlersFleetTestResponse
    """ # noqa: E501
    results: Optional[List[InternalHandlersPeerResult]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [InternalHandlersPeerResult.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
