...
```python
import hello_go5
from hello_go5.models.handlers_example_response import HandlersExampleResponse
from hello_go5.rest import ApiException
from pprint import pprint

# Defining the host is optional and defaults to http://localhost
# See configuration.py for a list of all supported configuration parameters.
configuration = hello_go5.Configuration(
    host = "http://localhost"
)
...
async with hello_go5.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = hello_go5.ExampleApi(api_client)
