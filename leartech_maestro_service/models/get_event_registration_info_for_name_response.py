...
class GetEventRegistrationInfoForNameResponse(BaseModel):
    """
    GetEventRegistrationInfoForNameResponse
    """ # noqa: E501
    error_description: Optional[StrictStr] = Field(default=None, alias="errorDescription")
    event_registration: Optional[EventRegistrationInfo] = Field(default=None, alias="eventRegistration")
    success: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["errorDescription", "eventRegistration", "success"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of event_registration
        if self.event_registration:
            _dict['eventRegistration'] = self.event_registration.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "eventRegistration": EventRegistrationInfo.from_dict(obj["eventRegistration"]) if obj.get("eventRegistration") is not None else None,
