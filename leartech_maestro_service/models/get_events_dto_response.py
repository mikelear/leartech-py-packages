...
class GetEventsDtoResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["errorDescription", "events", "success"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "events": [EventDto.from_dict(_item) for _item in obj["events"]] if obj.get("events") is not None else None,
