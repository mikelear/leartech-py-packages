...
class HandlersClientsResponse(BaseModel):
    """
    HandlersClientsResponse
    """ # noqa: E501
    checksums_url: Optional[StrictStr] = None
    clients: Optional[List[HandlersClientBinary]] = None
    version: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["checksums_url", "clients", "version"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "checksums_url": obj.get("checksums_url"),
            "clients": [HandlersClientBinary.from_dict(_item) for _item in obj["clients"]] if obj.get("clients") is not None else None,
