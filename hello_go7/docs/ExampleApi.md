...
```python
import hello_go7
from hello_go7.models.handlers_example_response import HandlersExampleResponse
from hello_go7.rest import ApiException
from pprint import pprint

# Defining the host is optional and defaults to http://localhost
# See configuration.py for a list of all supported configuration parameters.
configuration = hello_go7.Configuration(
    host = "http://localhost"
)
...
async with hello_go7.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = hello_go7.ExampleApi(api_client)
