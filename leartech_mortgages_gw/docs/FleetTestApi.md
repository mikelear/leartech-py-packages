# leartech_mortgages_gw.FleetTestApi
...
```python
import leartech_mortgages_gw
from leartech_mortgages_gw.models.handlers_fleet_test_response import HandlersFleetTestResponse
from leartech_mortgages_gw.rest import ApiException
from pprint import pprint

# Defining the host is optional and defaults to http://localhost
# See configuration.py for a list of all supported configuration parameters.
configuration = leartech_mortgages_gw.Configuration(
    host = "http://localhost"
)
...
async with leartech_mortgages_gw.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = leartech_mortgages_gw.FleetTestApi(api_client)
